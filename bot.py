...
Правила:
- supplier: кто ВЫСТАВИЛ счёт — это продавец/поставщик/исполнитель. Их название стоит в шапке счёта, рядом с ИНН/КПП/банком поставщика. НЕ бери значение из строки "Покупатель:" — там всегда ООО "Термодинамика" или похожее название получателя
