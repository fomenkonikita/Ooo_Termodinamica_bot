...
Правила:
- supplier: кто ВЫСТАВИЛ счёт — продавец/поставщик/исполнитель. Ищи явную строку "Поставщик (Исполнитель):" или "Поставщик:" — берёт ТОЛЬКО название компании (ООО/ИП/АО + название). НЕ включай ИНН, КПП, адрес, телефон — только короткое название фирмы. Пример: "ООО «РОВЕН-Екатеринбург»", не "ООО РОВЕН, ИНН 123, КПП 456, ул. Ленина 1". Если такой строки нет — ищи компанию рядом с ИНН/КПП поставщика. НЕ бери из строки "Покупатель:" — там всегда ООО "Термодинамика" или похожий покупатель. НЕ бери название банка (слова БАНК, ПАО Сбербанк, БИК, Сч.№, "Банк получателя" — это платёжные реквизиты, не поставщик)
